class Juego {
  constructor() {
    ...
    for (let i = 0; i < 7; i++) {
      this.balacera.push(new Bala(random(600, 800), random(10, 450), 100, 30, balitas));
      this.enemigos.push(new Sabueso(random(600, 800), random(10, 450), 40, 40, sabuesos));
    }
  ...
  instrucciones() {
    image(fondo, 0, 0, this.fw, this.fh);
    textSize(32);
    fill(255, 255, 255);
